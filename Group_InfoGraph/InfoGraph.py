...
def main(args):
    ...
    for rs in args.random_seed:
        ...
        train_loader, eval_loader = outline1.pre_data_ig(args)
        ...
        for epoch in range(1, args.epochs + 1):
            # train
            loss_all = outline1.train_ig(model, Cost_emb, Cost_div, train_loader, optimizer, device, args)
...
if __name__ == '__main__':
    ...
    args.embedding_dim = [64 * i for i in args.num_group]
