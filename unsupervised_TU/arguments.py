...
def arg_parse():
    ...
    parser.add_argument('--DS', default='REDDIT-BINARY', dest='DS', help='Dataset')
    ...
    parser.add_argument('--loss_margin_beta_lr', nargs='*', default=0.01, type=float)
    ...
    parser.add_argument('--mi_epochs', default=1, type=int)
