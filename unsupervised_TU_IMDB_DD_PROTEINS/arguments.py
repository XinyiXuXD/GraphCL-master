...
def arg_parse():
    ...
    parser.add_argument('--DS', default='PROTEINS', dest='DS', help='Dataset')
    ...
    parser.add_argument('--aug', nargs=2, default=['none', 'none'], type=str)
    ...
    parser.add_argument('--lam_div', nargs='*', default=[1.1], type=float)
    ...
    parser.add_argument('--club_hidden', default=20, type=int)
    parser.add_argument('--pos_pairs', type=str, default='true')
    parser.add_argument('--bias', type=str, default='false')
    parser.add_argument('--global_fea', type=str, default='pool12')
    parser.add_argument('--club_type', type=str, default='CLUBSample')
    parser.add_argument('--mi_epochs', default=5, type=int)
    parser.add_argument('--club_fea_norm', type=str, default='false')
    parser.add_argument('--club_learn_mu', type=str, default='true')
    parser.add_argument('--grouping-layer', type=str, default='mul_linear')
